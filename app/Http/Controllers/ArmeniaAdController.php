...
use App\Models\{ArmeniaAd, Keyword, AdImage};

class ArmeniaAdController extends Controller
{
    public function postAd(Request $request)
    {
        ...
        if(!$post)
        {
            ...
            return redirect()->route('ad.categories', 7)->with('success', 'Your Post Created Successfully !');
        }
    }
