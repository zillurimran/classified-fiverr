                ...
                <div class="container">
                    <div class="text-center text-white">
                        ...
                        <ol class="breadcrumb text-center">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Update Package</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 col-md-12">
                    <form
                    role="form"
                    action="{{ route('update.ad.package', $updatedPost->id) }}"
                    method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="package_id">
                                        ...
                                        @foreach($packages as $package)
                                            <option value="{{$package->id}}" @if($package->id == $updatedPost->package_id) selcted @endif>{{$package->days." - days ".$package->package_price."$"}}</option>
                                        @endforeach
                                    </select>
                                    @error('package_id')
