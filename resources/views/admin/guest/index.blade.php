...
@section('title')
    {{ config("app.name") }} | Guest Messages
@endsection

@section('guestMessages')
    active
@endsection
...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Guest Messages</li>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-toggle="modal" data-target="#exampleModalCenter{{ $message->id }}" title="Delete">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Are You Sure To Delete Entire Message?
                                            </div>
