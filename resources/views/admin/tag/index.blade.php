    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex">
                    <a href="" class="btn btn-primary" data-toggle="modal" data-target="#addPackageModal"><i data-feather='plus' class="mr-25"></i>Create Tag</a>
                ...
                <table class="table table-bordered table-hover datatable text-center">
                    ...
                    <tbody>
                        @foreach ($tags as $tag)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"  data-toggle="modal" data-target="#editModal{{ $tag->id }}" title="Delete">
                                                <i data-feather='edit' class="mr-50"></i>
                                                <span>Edit</span>
                                            </a>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#exampleModalCenter{{ $tag->id }}" title="Delete">
                            ...
                            @push('all-modals')
                            <!-- Delete Modal -->
                            <div class="modal fade" id="editModal{{ $tag->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{route('tag.update', $tag->id)}}" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="name">Tag Name</label>
                                                    <input type="text" name="name" class="form-control" value="{{ $tag->name }}" placeholder="Name">
                                                    @error('name')
                                                        <small class="text-danger">{{$message}}</small>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('tag.destroy', $tag->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('delete')
